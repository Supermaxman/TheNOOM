...
public class TheNoomSurfacePopulator extends BlockPopulator {
    public final int CRATER_CHANCE = 2;
    public final int TOWER_CHANCE = 2;
    public final int FORTRESS_CHANCE = 2;
    public final int GLOWSTONE_CHANCE = 10000;
    public final int ENDSTONE_CHANCE = 30000;
    public final int ROOM_HEIGHT = 10;
    public final int D_HEIGHT = 41;
    public final int T_CHANCE = 10;
    public final int S_CHANCE = 5;
    public final int CLEAR_CACHE = 1000;

    public final Material STONE = Material.NETHERRACK;
    public final Material AIR = Material.AIR;
    public final Material ESTONE = Material.ENDER_STONE;
    public final Material GSTONE = Material.GLOWSTONE;
    public final Material SSAND = Material.SOUL_SAND;
    public final Material SANDSTONE = Material.SANDSTONE;
    public final Material BEDROCK = Material.BEDROCK;
    public final Material BRICK = Material.NETHER_BRICK;
    public Material STAIRS = Material.NETHER_BRICK_STAIRS;
    public final Material SPAWNER = Material.MOB_SPAWNER;
    public final Material CHEST = Material.CHEST;
    public final Material WORKBENCH = Material.WORKBENCH;
    public final Material FURNACE = Material.FURNACE;
    public final Material NWARTS = Material.NETHER_WARTS;
    public final Material OBSIDIAN = Material.OBSIDIAN;
    public final Material FENCE = Material.NETHER_FENCE;
    public final Material LAVA = Material.LAVA;
    public final Material RSHROOM = Material.RED_MUSHROOM;
    public final Material BSHROOM = Material.BROWN_MUSHROOM;
    public final Material RTORCH = Material.REDSTONE_TORCH_ON;
    public final Material RLAMP = Material.REDSTONE_LAMP_ON;
    public final Material IBARS = Material.IRON_FENCE;
    public final Material WATER = Material.WATER;
    public final Material CMATERIAL = SSAND;
    public final Material TSOIL = SANDSTONE;
    private Random hillseed = null;
    private SimplexOctaveGenerator gen = null;
    public final HashMap<Chunk, Integer> hasDungeon = new HashMap<Chunk, Integer>();
    static final HashMap<Chunk, Integer> spaceShip = new HashMap<Chunk, Integer>();
    ...
    public void populate(World world, Random random, Chunk source) {
        ...
        if ((random.nextInt(400) < this.TOWER_CHANCE)) {
            ...
            int size = 10;
            createTower(source, startYN, size, roomsLeft, this.OBSIDIAN, random);
